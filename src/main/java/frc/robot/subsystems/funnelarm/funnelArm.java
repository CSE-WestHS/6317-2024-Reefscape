...
public class funnelArm extends SubsystemBase {
  private final funnelArmIO funnelArm;
  private final funnelArmIOInputsAutoLogged inputs = new funnelArmIOInputsAutoLogged();
  ...
  public funnelArm(funnelArmIO io, funnelArmGains gains) {
    funnelArm = io;
  ...
  public void periodic() {
    funnelArm.updateInputs(inputs);
    Logger.processInputs(name, inputs);

    velocitySetpoint = profile.calculateSetpoint();
    funnelArm.setVelocity(velocitySetpoint);
