...
public class FunnelIOSim implements FunnelIO {
  ...
  public FunnelIOSim(String name, FunnelHardwareConfig config) {
    this.name = name;
    ...
    setGains(FunnelConstants.SIM_GAINS); //sets sim gains for simulation
  }
  @Override
  ...
  @Override
  public void setGains(FunnelGains gains) {
