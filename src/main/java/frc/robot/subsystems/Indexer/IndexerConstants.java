...
public class IndexerConstants {
  ...
  public static final IndexerHardwareConfig EXAMPLE_CONFIG =
      new IndexerHardwareConfig(new int[] {11,12}, new boolean[] {false,true}, 2.0, 15, "");

  public static final IndexerHardwareConfig CompBot_CONFIG =
      new IndexerHardwareConfig(new int[] {11,12}, new boolean[] {true,true}, 20.0, 15
      , "");
  ...
  public static final IndexerGains REAL_GAINS =
      new IndexerGains(0, 0.0, 0, 0.0, 0.3, 0.0, 30.0, 0.2);
}
