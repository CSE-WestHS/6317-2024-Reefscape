...
public class IndexerIOSim implements IndexerIO {
  ...
  private final IndexerHardwareConfig config;
  ...
  public IndexerIOSim(String name, IndexerHardwareConfig config) {
    this.name = name;
    ...
    setGains(IndexerConstants.SIM_GAINS); //sets sim gains for simulation
  }
  @Override
