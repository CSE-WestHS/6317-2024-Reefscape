...
public class LEDS {
    ...
    public void runLEDS() {
        ...
        // if (Math.abs(RobotContainer.getController().getLeftX()) >0.1 && (Math.abs(RobotContainer.getController().getLeftY()) >0.1)) {
            
        //     cyan.blend(green).applyTo(ledbuffer);
        //     led.setData(ledbuffer);
        // }
        else if (Math.abs(RobotContainer.getController().getLeftY()) >0.1) {
            // green.applyTo(ledbuffer);
            // cyan.offsetBy(5).overlayOn(red).applyTo(ledbuffer);
            // led.setData(ledbuffer);
        ...
        // else if (Math.abs(RobotContainer.getController().getLeftX()) >0.1) {
        //     green.applyTo(ledbuffer);
        //     led.setData(ledbuffer);
        // }
