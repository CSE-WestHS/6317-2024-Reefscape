...
public class Clamps extends SubsystemBase {
  private final ClampsIO clamps;
  private final ClampsIOInputsAutoLogged inputs = new ClampsIOInputsAutoLogged();
  ...
  public Clamps(ClampsIO io, ClampsGains gains) {
    clamps = io;
  ...
  public void periodic() {
    clamps.updateInputs(inputs);
    Logger.processInputs(name, inputs);

    velocitySetpoint = profile.calculateSetpoint();
    clamps.setVelocity(velocitySetpoint);
