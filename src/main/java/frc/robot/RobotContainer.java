...
//   private final LEDS led;
  ...
  private final static CommandJoystick varJoystick = new CommandJoystick(2);
    // Dashboard inputs
    ...
    private void configureButtonBindings() {
      ...
      ButtonBoardButtons.PNEUMATIC_OUT.onTrue(Commands.run((()->System.out.println("brain hurts"))));
    }
